# Generated from ClickHouseParser.g4 by ANTLR 4.13.2
from antlr4 import *
if "." in __name__:
...
class ClickHouseParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by ClickHouseParser#QueryStmtQuery.
    def visitQueryStmtQuery(self, ctx:ClickHouseParser.QueryStmtQueryContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#QueryStmtInsert.
    def visitQueryStmtInsert(self, ctx:ClickHouseParser.QueryStmtInsertContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#QueryStmtDelete.
    def visitQueryStmtDelete(self, ctx:ClickHouseParser.QueryStmtDeleteContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#QueryStmtUpdate.
    def visitQueryStmtUpdate(self, ctx:ClickHouseParser.QueryStmtUpdateContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ClickHouseParser#ttlSetExpr.
    def visitTtlSetExpr(self, ctx:ClickHouseParser.TtlSetExprContext):
        return self.visitChildren(ctx)
    ...
    def visitExplainStmt(self, ctx:ClickHouseParser.ExplainStmtContext):
        return self.visitChildren(ctx)
    ...
    def visitAssignmentValues(self, ctx:ClickHouseParser.AssignmentValuesContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#assignmentValue.
    def visitAssignmentValue(self, ctx:ClickHouseParser.AssignmentValueContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#deleteStmt.
    def visitDeleteStmt(self, ctx:ClickHouseParser.DeleteStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#inPartitionClause.
    def visitInPartitionClause(self, ctx:ClickHouseParser.InPartitionClauseContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#updateStmt.
    def visitUpdateStmt(self, ctx:ClickHouseParser.UpdateStmtContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ClickHouseParser#renameEntityClause.
    def visitRenameEntityClause(self, ctx:ClickHouseParser.RenameEntityClauseContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ClickHouseParser#WithExprSubquery.
    def visitWithExprSubquery(self, ctx:ClickHouseParser.WithExprSubqueryContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#WithExprExpression.
    def visitWithExprExpression(self, ctx:ClickHouseParser.WithExprExpressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ClickHouseParser#GroupByClauseAll.
    def visitGroupByClauseAll(self, ctx:ClickHouseParser.GroupByClauseAllContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#GroupByClauseCubeOrRollup.
    def visitGroupByClauseCubeOrRollup(self, ctx:ClickHouseParser.GroupByClauseCubeOrRollupContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#GroupByClauseGroupingSets.
    def visitGroupByClauseGroupingSets(self, ctx:ClickHouseParser.GroupByClauseGroupingSetsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#GroupByClauseSimple.
    def visitGroupByClauseSimple(self, ctx:ClickHouseParser.GroupByClauseSimpleContext):
        return self.visitChildren(ctx)
    ...
    def visitInterpolateClause(self, ctx:ClickHouseParser.InterpolateClauseContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ClickHouseParser#showCreateViewStmt.
    def visitShowCreateViewStmt(self, ctx:ClickHouseParser.ShowCreateViewStmtContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ClickHouseParser#showColumnsStmt.
    def visitShowColumnsStmt(self, ctx:ClickHouseParser.ShowColumnsStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showIndexStmt.
    def visitShowIndexStmt(self, ctx:ClickHouseParser.ShowIndexStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showProcessListStmt.
    def visitShowProcessListStmt(self, ctx:ClickHouseParser.ShowProcessListStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showGrantsStmt.
    def visitShowGrantsStmt(self, ctx:ClickHouseParser.ShowGrantsStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showCreateUserStmt.
    def visitShowCreateUserStmt(self, ctx:ClickHouseParser.ShowCreateUserStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showCreateRoleStmt.
    def visitShowCreateRoleStmt(self, ctx:ClickHouseParser.ShowCreateRoleStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showCreatePolicyStmt.
    def visitShowCreatePolicyStmt(self, ctx:ClickHouseParser.ShowCreatePolicyStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showCreateQuotaStmt.
    def visitShowCreateQuotaStmt(self, ctx:ClickHouseParser.ShowCreateQuotaStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showCreateProfileStmt.
    def visitShowCreateProfileStmt(self, ctx:ClickHouseParser.ShowCreateProfileStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showUsersStmt.
    def visitShowUsersStmt(self, ctx:ClickHouseParser.ShowUsersStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showRolesStmt.
    def visitShowRolesStmt(self, ctx:ClickHouseParser.ShowRolesStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showProfilesStmt.
    def visitShowProfilesStmt(self, ctx:ClickHouseParser.ShowProfilesStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showPoliciesStmt.
    def visitShowPoliciesStmt(self, ctx:ClickHouseParser.ShowPoliciesStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showQuotasStmt.
    def visitShowQuotasStmt(self, ctx:ClickHouseParser.ShowQuotasStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showQuotaStmt.
    def visitShowQuotaStmt(self, ctx:ClickHouseParser.ShowQuotaStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showAccessStmt.
    def visitShowAccessStmt(self, ctx:ClickHouseParser.ShowAccessStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showClusterStmt.
    def visitShowClusterStmt(self, ctx:ClickHouseParser.ShowClusterStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showClustersStmt.
    def visitShowClustersStmt(self, ctx:ClickHouseParser.ShowClustersStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showSettingsStmt.
    def visitShowSettingsStmt(self, ctx:ClickHouseParser.ShowSettingsStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showSettingStmt.
    def visitShowSettingStmt(self, ctx:ClickHouseParser.ShowSettingStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showFilesystemCaches.
    def visitShowFilesystemCaches(self, ctx:ClickHouseParser.ShowFilesystemCachesContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showEnginesStmt.
    def visitShowEnginesStmt(self, ctx:ClickHouseParser.ShowEnginesStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showFunctionsStmt.
    def visitShowFunctionsStmt(self, ctx:ClickHouseParser.ShowFunctionsStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showMergesStmt.
    def visitShowMergesStmt(self, ctx:ClickHouseParser.ShowMergesStmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#showPrivilegesStmt.
    def visitShowPrivilegesStmt(self, ctx:ClickHouseParser.ShowPrivilegesStmtContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ClickHouseParser#ColumnExprCastSymbol.
    def visitColumnExprCastSymbol(self, ctx:ClickHouseParser.ColumnExprCastSymbolContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ClickHouseParser#columnExceptExprRegexp.
    def visitColumnExceptExprRegexp(self, ctx:ClickHouseParser.ColumnExceptExprRegexpContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ClickHouseParser#columnExceptExprIdentifiers.
    def visitColumnExceptExprIdentifiers(self, ctx:ClickHouseParser.ColumnExceptExprIdentifiersContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ClickHouseParser#dictionaryIdentifier.
    def visitDictionaryIdentifier(self, ctx:ClickHouseParser.DictionaryIdentifierContext):
        return self.visitChildren(ctx)
